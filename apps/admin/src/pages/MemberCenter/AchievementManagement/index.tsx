...
const AchievementManagement: React.FC<BrowserRouterProps> = () => {
    ...
    <div className={styles.container} ref={containerRef}>
      <Space direction='vertical'>
        ...
        <Form
          ...
          labelAlign='left'
        >
          <FormItem label='成就名' name='userName'>
            <Input />
          </FormItem>
          <FormItem label='成就Id' name='userId'>
            <Input />
          </FormItem>
          <FormItem>
...
export default memo(AchievementManagement);
